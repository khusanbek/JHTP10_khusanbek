...
// GradeBook class using an two-dimensional array to store grades.
...
public class GradeBook
{
	...
	// two-dimensional constructor initializes courseName and grades array
	...
	public int getMinimum()
	{
		...
		{
			// loop through columns of current array
	...
	public void outputGrades()
	{
		...
		for(int student = 0; student < grades.length; student++)
		{
			...
			for(int test : grades[student]) // output stuedent's grades
				System.out.printf("%8d", test);
				
			// call method getAverage to calculate stuedent's average grade.
